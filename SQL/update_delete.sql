...
values ('Knjigovođa',293,null,null);

insert into smjerovi (naziv, cijena, izvodiseod, vaucer)
values ('Turistički vodič',477,null,null);

insert into smjerovi (naziv, cijena, izvodiseod, vaucer)
values ('Pivar',297,null,null);

insert into smjerovi (naziv, cijena, izvodiseod, vaucer)
values ('Geodet',1317,null,null);

insert into smjerovi (naziv, cijena, izvodiseod, vaucer)
values ('Trgovac',157,null,null);
